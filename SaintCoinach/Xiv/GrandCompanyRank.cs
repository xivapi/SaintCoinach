...
namespace SaintCoinach.Xiv {
    public class GrandCompanyRank : XivRow {
        ...
        public Imaging.ImageFile MaelstromIcon { get { return AsImage("Icon{Maelstrom}"); } }
        public Imaging.ImageFile SerpentsIcon { get { return AsImage("Icon{Serpents}"); } }
        public Imaging.ImageFile FlamesIcon { get { return AsImage("Icon{Flames}"); } }
        ...
        #region Constructor
        public GrandCompanyRank(IXivSheet sheet, Ex.Relational.IRelationalRow sourceRow) : base(sheet, sourceRow) { }
        #endregion
    }
}